...
export function Navbar() {
    return <div
        className="fixed top-0 left-0 right-0 z-50 flex justify-between bg-black border-gray-300 border-1 rounded-2xl shadow-lg m-4 p-4 md:relative md:min-h-screen md:justify-start md:items-start md:flex-col md:p-6 md:gap-4">
        <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-white">Logo Inc.</span>
        </div>
